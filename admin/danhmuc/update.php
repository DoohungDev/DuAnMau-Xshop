    ...
    <div class="form-add">
        <form action="index.php?act=updatedm" method="post">
            <div class="form my-4">
                ...
                <input type="text" name="maloai" id="" value="<?php if(isset($id) && $id > 0) echo $id?>" placeholder="Auto number update" class="border rounded-lg w-full px-2 py-2" disabled><br>
                <span>Tên loại</span><br>
                <input type="text" name="tenloai" value="<?php if(isset($name) && $name != "") echo $name?>" placeholder="Nhập tên sản phẩm" class="border rounded-lg w-full px-2 py-2">
            </div>
