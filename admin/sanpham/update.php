    ...
    <div class="form-add">
        <form action="index.php?act=updatesp" method="post">
            <div class="form my-4">
                ...
                <input type="text" name="tensp" value="<?=$name?>" placeholder="Nhập tên sản phẩm"
                    class="border rounded-lg w-full px-2 py-2"><br>
                <span>Giá sản phẩm</span><br>
                <input type="text" name="giasp" value="<?=$price?>" placeholder="Nhập tên sản phẩm"
                    class="border rounded-lg w-full px-2 py-2"><br>
                ...
                <textarea name="mota" id="" value="<?=$mota?>" placeholder="Nhập tên sản phẩm"
